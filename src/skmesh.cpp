...
void SkinnedMesh::ReadNodeHeirarchy(double AnimationTime, const aiNode* pNode, const glm::mat4& ParentTransform)
    {
...
void SkinnedMesh::BoneTransform(double timeInSeconds, std::vector<glm::mat4>& Transforms)
{
    glm::mat4 Identity = glm::mat4(1.0f);
    
    /* Calc animation duration */
    auto numPosKeys = m_pScene->mAnimations[currentAnimation]->mChannels[0]->mNumPositionKeys;
    double animDuration = m_pScene->mAnimations[currentAnimation]->mChannels[0]->mPositionKeys[numPosKeys - 1].mTime;
